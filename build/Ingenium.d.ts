...
export declare class Vec3 {
    ...
    */
    ...
    assign(v2: Vec3): void;
    addEquals(v2: Vec3): void;
    subEquals(v2: Vec3): void;
    mulEquals(v2: Vec3): void;
    divEquals(v2: Vec3): void;
    addEqualsFloat(v2: number): void;
    subEqualsFloat(v2: number): void;
    mulEqualsFloat(v2: number): void;
    divEqualsFloat(v2: number): void;
...
export declare class Shader {
    ...
    static make3D(params?: any): Shader;
    static make2D(params?: any): Shader;
...
export declare class Mesh3D extends Position3D {
    ...
    */
    ...
    render(s: Shader, c: Camera3D, d?: DirectionalLight, p?: PointLight[]): void;
    ...
    static createColourTexture(colour: number, alpha?: number, texSlot?: number, wrap?: number[], minFilter?: number, magFilter?: number): WebGLTexture;
    /**
    ...
    static createAndMake(obj: string, diff?: string, spec?: string, norm?: string, bump?: string): Mesh3D;
    setRawVertexData(index: number, data: number[]): void;
    getRawVertexdata(index: number, length: number, stride?: number): number[];
    /**
...
export declare class Mesh2D extends Position2D {
    ...
    */
    ...
    bindVBO(): void;
    bindVAO(): void;
    render(shader: Shader, camera: Camera2D): void;
    static renderAll(shader: Shader, camera: Camera2D, meshes: Mesh2D[]): void;
    static makeQuad(texturePath?: string): Mesh2D;
}
/**
...
export declare class AnimatedMesh3D {
    meshes: Mesh3D[];
    primaryMesh: Mesh3D;
    currentFrame: number;
    startFrame: number;
    ...
    interpolatingTint: boolean;
    interpolatingVerticies: boolean;
    constructor(base: Mesh3D, meshes?: Mesh3D[], endFrame?: number, frameTime?: number);
    checkAdvanceFrame(): void;
    render(s: Shader, c: Camera3D, d?: DirectionalLight, p?: PointLight[]): void;
}
export {};
