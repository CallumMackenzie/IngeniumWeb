...
function onGlobalCreate() {
    ...
    dLight = new DirectionalLight(new Vec3(0.01, 0.01, 0.01), new Vec3(0.1, 0.1, 0.1),
        new Vec3(0.1, 0.1, 0.1), new Vec3(0.2, -1, 0.5), 1);
...
function onCreateDefScene() {
    ...
    new Vec3(0.1, 0.1, 0.1), new Vec3(1, 1, 3)));
}
function onUpdateDefScene() {
    var speed: number = 0.01;
    var cameraMoveSpeed: number = 0.0015;
